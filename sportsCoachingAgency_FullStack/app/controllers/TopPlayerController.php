...
class TopPlayerController extends BaseController
{
  ...
  public function create()
  {
      ...
      if ($_SERVER['REQUEST_METHOD'] === 'POST') {
          ...
          $formData['position'] = $_POST['position'] ?? '';
          $formData['team'] = $_POST['team'] ?? '';
          $formData['height_ft'] = $_POST['height_ft'] ?? '';
          $formData['height_in'] = $_POST['height_in'] ?? '';
          $formData['weight_lbs'] = $_POST['weight_lbs'] ?? '';
          $formData['points_per_game'] = $_POST['points_per_game'] ?? '';
          $formData['assists_per_game'] = $_POST['assists_per_game'] ?? '';
          $formData['rebounds_per_game'] = $_POST['rebounds_per_game'] ?? '';
          $formData['field_goal_percentage'] = $_POST['field_goal_percentage'] ?? '';
          $formData['three_point_percentage'] = $_POST['three_point_percentage'] ?? '';
          ...
          if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
              ...
              if (empty($errors)) {
                  ...
                  if (move_uploaded_file($_FILES['image']['tmp_name'], $targetFile)) {
                      $formData['image_url'] = '/uploads/players/' . $fileName;
                  } else {
