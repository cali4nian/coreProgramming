...
<section class="settings-form-container">
  <form action="/admin/update-site-settings" method="POST" enctype="multipart/form-data">
    ...
    <h2>Site Settings</h2>
    <p class="settings_text_instructions">Update your site settings below. These settings will be used across the site.</p>
...
<section class="settings-form-container">
  <form action="/admin/update-social-media-settings" method="POST">
    ...
    <p class="settings_text_instructions">Enter the URLs for your social media accounts. These will be used to display icons on the front page. If left empty the icons on the front page will not be shown.</p>
    <div class="form-group">
...
<section class="settings-form-container">
  <form action="/admin/update-home-page-settings" method="POST" enctype="multipart/form-data">
    ...
    <p class="settings_text_instructions">Update your home page settings below. These settings will be used on the home page.</p>
    <div class="form-group">
...
<section class="settings-form-container">
  <form action="/admin/update-about-page-settings" method="POST" enctype="multipart/form-data">
    ...
    <p class="settings_text_instructions">Update your about page settings below. These settings will be used on the about page.</p>
